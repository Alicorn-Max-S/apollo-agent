...
description: "Apollo — the AI learning companion built by Alicorn-Max-S. A built-in learning loop that creates skills from experience, illuminates your path to mastery, and remembers across sessions."
hide_table_of_contents: true
---

# Apollo

The AI learning companion built by [Alicorn-Max-S](https://nousresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.

<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  <a href="/docs/getting-started/installation" style={{display: 'inline-block', padding: '0.6rem 1.2rem', backgroundColor: '#FEE66E', color: '#0f0c12', borderRadius: '8px', fontWeight: 600, textDecoration: 'none'}}>Get Started →</a>
  <a href="https://github.com/Alicorn-Max-S/apollo-agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(254,230,110,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>

## What is Apollo?

It's not a coding copilot tethered to an IDE or a chatbot wrapper around a single API. It's an **AI learning agent** that grows alongside you — illuminating your path through complex subjects, remembering what you've studied, and getting more capable the longer it runs. It lives wherever you put it — a $5 VPS, a GPU cluster, or serverless infrastructure (Daytona, Modal) that costs nearly nothing when idle.
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Apollo safely |
| 🧭 **[Use MCP with Apollo](/docs/guides/use-mcp-with-apollo)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Apollo](/docs/guides/use-voice-mode-with-apollo)** | Hands-on setup and usage patterns for Apollo voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Apollo's default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Apollo |
...
- **Built by model trainers** — Created by [Alicorn-Max-S](https://nousresearch.com), the lab behind Apollo, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Alicorn-Max-S](https://nousresearch.com) — the lab behind Apollo, Nomos, and Psyche models
