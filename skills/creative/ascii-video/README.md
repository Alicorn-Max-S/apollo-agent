...
Built for [Apollo Agent](https://github.com/Alicorn-Max-S/apollo-agent). Usable in any coding agent. Canonical source lives here; synced to [`Alicorn-Max-S/apollo-agent/skills/creative/ascii-video`](https://github.com/Alicorn-Max-S/apollo-agent/tree/main/skills/creative/ascii-video) via PR.
